...
export default function ResumePreview({
  ...
  resume: ResumeShowResponse["resume"];
}) {
  ...
  return (
    <div className="resume-preview">
      <div className="resume-toolbar print:hidden">
        ...
        <p className="text-sm">
          印刷画面で「PDFとして保存」、用紙「A4」、倍率「100%」を選び、ヘッダーとフッターをオフにしてください。
        </p>
        <p aria-live="polite" className="text-sm mt-2 text-amber-800">
          {ready && scale < 0.8
            ? "内容が多いため、文字が小さくなっています。職歴の説明を短くすると読みやすくなります。"
            : ""}
        </p>
      </div>
      <div
        className="resume-paper"
        aria-label="履歴書 A4プレビュー"
        aria-busy={!ready}
      >
        <div ref={pageRef} className="resume-page-area">
          <div
            ...
            data-job-count={resume.jobExperiences.length}
          >
            {/* ================= Header ================= */}
